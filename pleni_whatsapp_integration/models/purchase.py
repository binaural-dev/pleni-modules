...
class PurchaseOrderModule(models.Model):
    ...
    def purchase_whatsapp(self):
        ...
        if not record_phone[0] == '+':
            ...
            return {
                ...
                'view_type': 'form',
                'context': {
                    'default_template_id': self.env.ref('pleni_whatsapp_integration.whatsapp_purchase_template').id},
            }
    ...
    def send_direct_message(self):
        ...
        custom_msg = "Hola *{}*, tu Orden de Compra *{}* con el monto de *{} {}* está lista.\nLa orden contiene los siguientes items: \n{}".format(
    ...
    def multi_sms(self):
        ...
        for purchase in purchase_order_ids:
            customer_ids.append(purchase.partner_id.id)
