...
odoo.define('website_uom_select_suggetion_spt.MultiUomWebsiteSale', function (require) {
  ...
  publicWidget.registry.WebsiteSale.include({
     ...
     */
    _handleAdd: function _handleAdd($form) {
      var self = this;
      this.$form = $form;
     ...
     * @private
     */
    _setUrlHash: function _setUrlHash($parent) {
    ...
    _onChangeCombination: function _onChangeCombination(ev, $parent, combination) {
  ...
  publicWidget.registry.MultiUOMWebsiteSale = publicWidget.Widget.extend(KitsWebsiteSale, {
    ...
    onChangeUOM: function onChangeUOM(ev) {
