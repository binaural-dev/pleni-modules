...
class L10nUt(models.Model):
    ...
    date = fields.Date(string='Date', required=True, help="Date on which goes into effect the new Unit Tax Unit")
    amount = fields.Float(string='Amount', digits='Amount Bs per UT', help="Amount of the tax unit in bs",
                          required=True)
