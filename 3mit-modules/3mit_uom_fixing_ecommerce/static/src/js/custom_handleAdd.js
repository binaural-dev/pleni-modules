odoo.define('3mit_uom_fixing_ecommerce.custom_handleAdd', function (require) {
    'use strict';
    ...
    core.action_registry.add('3mit_uom_fixing_ecommerce.custom_handleAdd', publicWidget);
