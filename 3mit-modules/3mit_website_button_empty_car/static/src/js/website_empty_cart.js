odoo.define('3mit_website_button_empty_car.website_empty_cart', function (require) {
    'use strict';
    ...
    core.action_registry.add('3mit_website_button_empty_car.website_empty_cart', publicWidget);
