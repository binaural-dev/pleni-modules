odoo.define('3mit_custom_signup_ecommerce.custom_my_details_portal', function (require) {
    'use strict';
    ...
    publicWidget.registry.portalDetails = publicWidget.Widget.extend({
        ...
        _onCountryChange: async function () {
            ...
            const allCountries = await ajax.rpc('/getStatesById', {'input_country_id': inputCountryId});
    ...
    core.action_registry.add('3mit_custom_signup_ecommerce.custom_my_details_portal', publicWidget);
