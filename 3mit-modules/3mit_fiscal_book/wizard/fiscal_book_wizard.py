    ...
    def check_report(self):
       if self.type == 'purchase':
            ...
            #        datas = self.read(self.id)[0]
                    data = {
                        'ids': ids,
                        'model': 'report.3mit_fiscal_book.report_fiscal_purchase_book',
                        'form': {
                    #        'datas': datas,
                    ...
                    return self.env.ref('3mit_fiscal_book.report_purchase_book').report_action(self, data=data) #, config=False
                else:
            ...
            if self.date_start and self.date_end:
               ...
               #     datas = self.read(self.ids)[0]
                    data = {
                        'ids': ids,
                        'model': 'report.3mit_fiscal_book.report_fiscal_sale_book',
                        'form': {
                          #  'datas': datas,
                            'date_from': self.date_start,
                            'date_to': self.date_end,
                  ...
                  #      'context': self._context
                    ...
                    return self.env.ref('3mit_fiscal_book.report_sale_book').report_action(self, data=data, config=False)
                else:
                    raise ValidationError('Advertencia! No existen facturas entre las fechas seleccionadas')
    ...
    def _get_report_values(self, docids, data=None):
        ...
        for h in purchasebook_ids:
            ...
            if partner and len(partner) == 1:
                ...
                if h.invoice_id:
                    partner_1 = h.invoice_id.partner_id
                elif h.iwdl_id.invoice_id.id:
                    partner_1 = h.iwdl_id.invoice_id.partner_id
                else:
            ...
            if (partner_1.company_type == 'company' or  partner_1.company_type == 'person') and (partner_1.people_type_company or partner_1.people_type_individual) and  (partner_1.people_type_company == 'pjdo' or partner_1.people_type_individual == 'pnre' or  partner_1.people_type_individual == 'pnnr'):
                ...
                if h.invoice_id:
                    ...
                    vat_reduced_rate = round((h.vat_reduced_base and h.vat_reduced_tax * 100 / h.vat_reduced_base), 0)
                    vat_reduced_tax = h.vat_reduced_tax
                    vat_additional_base = h.vat_additional_base
                    vat_additional_rate = round((h.vat_additional_base and h.vat_additional_tax * 100 / h.vat_additional_base), 0)
                ...
                if h.iwdl_id.invoice_id:
                    ...
                    h_vat_general_tax = h.vat_general_tax if h.vat_general_tax else 0.0
                    vat_reduced_base = h.vat_reduced_base
                    vat_reduced_rate = (h.vat_reduced_base and h.vat_reduced_tax * 100 / h.vat_reduced_base)
                    vat_reduced_rate = round(vat_reduced_rate, 0)
                    vat_reduced_tax = h.vat_reduced_tax
                    vat_additional_base = h.vat_additional_base
                    vat_additional_rate = (h.vat_additional_base and h.vat_additional_tax * 100 / h.vat_additional_base)
                    vat_additional_rate = round(vat_additional_rate, 0)
                    vat_additional_tax = h.vat_additional_tax
                    get_wh_vat = h.get_wh_vat
            ...
            if (partner_1.company_type == 'company' or  partner_1.company_type == 'person') and (partner_1.people_type_company or partner_1.people_type_individual) and  partner_1.people_type_company == 'pjnd':
                ...
                vat_reduced_rate_importaciones = (h.vat_reduced_base and h.vat_reduced_tax * 100 / h.vat_reduced_base)
                vat_reduced_rate_importaciones = round(vat_reduced_rate_importaciones, 0)
                ...
                vat_additional_rate_importaciones = (h.vat_additional_base and h.vat_additional_tax * 100 / h.vat_additional_base)
                vat_additional_rate_importaciones = round(vat_additional_rate_importaciones, 0)
    ...
    def _get_report_values(self, docids, data=None):
        ...
        fbl_obj = self.env['fiscal.book.line'].search(
            [('fb_id','=',busq.id),('accounting_date', '>=', date_start)
             ], order='emission_date,ctrl_number asc')
        ...
        for line in fbl_obj:
            if line.vat_general_base != 0 or line.is_old or line.vat_reduced_base != 0 or line.vat_additional_base != 0 or line.vat_exempt != 0 or (line.void_form == '03-ANU' and line.invoice_number) or line.void_form == '02-COMP':
                vat_general_base = 0
                vat_general_rate =  0
                vat_general_tax =  0
                vat_reduced_base = 0
                ...
                if line.get_wh_vat and not line.is_old:
                ...
                #     vat_reduced_tax = 0
                if line.is_old:
                    suma_get_wh_vat_old += line.get_wh_vat
                    docs1.append({
                        'rannk': line.rank,
        ...
        return {
            ...
            'suma_get_wh_vat_old': suma_get_wh_vat_old,
            ...
            'sum_total': suma_get_wh_vat + suma_get_wh_vat_old,
        }
#
#
# FiscalBookWizard()
