...
class RetentionISLR(models.Model):
    ...
    def generate_retention_islr_pdf(self):
        ...
        data = {
            'ids': self.ids,
            'model': 'report.3mit_retention_islr.report_retention_islr1',
            'form': {
        ...
        return self.env.ref('3mit_retention_islr.action_report_retention_islr').report_action(self, data=data)
