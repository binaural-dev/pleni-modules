odoo.define('3mit_uom_fixing_ecommerce.custom_quickView', function (require) {
    'use strict';
    ...
    core.action_registry.add('3mit_uom_fixing_ecommerce.custom_quickView', publicWidget);
